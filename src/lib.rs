...
impl Entity {
    fn new(user: &String, group: &String, firstname: &String, lastname: &String, mail: &String, 
        default_qos: &String, publickey: &String, qos: &Vec<String>, config: &MgmtConfig) -> Self {
...
impl Modifiable {
    fn new(username: &String, firstname: &Option<String>, lastname: &Option<String>, 
        mail: &Option<String>, default_qos: &Option<String>, 
        publickey: &Option<String>, qos: &Vec<String>) -> Self {
...
fn modify_user(user: &String, firstname: &Option<String>, lastname: &Option<String>, 
                mail: &Option<String>, mut default_qos: &Option<String>, 
                publickey: &Option<String>, qos: &Vec<String>, 
    ...
    let modifiable = Modifiable::new(user, firstname, lastname, mail, 
                                                default_qos, &pubkey_from_file, &filtered_qos);
